    ...
    <>
      ...
      <NavScrollState>
        <a href="#" className="flex items-center gap-3">
          <Image alt="红牛 Logo" className="nav-logo object-contain" src="/assets/hongniu-logo-icon.png" width={80} height={80} />
        ...
        <section className="story-block bg-surface/40 backdrop-blur-sm overflow-hidden" id="about">
          ...
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-24 items-center relative z-10">
            ...
            <div className="space-y-12">
              ...
              <StaggerContainer stagger={0.1} className="space-y-10">
                <StaggerItem>
